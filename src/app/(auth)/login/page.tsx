...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Better Auth native endpoint — validates against Neon and sets the
      // signed HttpOnly session cookie server-side.
      ...
      if (res.ok && data.token) {
        // New users land on the 5-step DNA questionnaire; returning users go
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-1">Sign in to LinkedGrow AI</p>
        </div>
